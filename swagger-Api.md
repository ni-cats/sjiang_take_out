...
| 参数名称 | 参数说明 | 类型 | schema |
| -------- | -------- | ----- |----- | 
|code|编码|integer(int32)|integer(int32)|
|data|数据|AddressBook|AddressBook|
...
| -------- | -------- | ----- |----- | 
|code|编码|integer(int32)|integer(int32)|
|data|数据|ShoppingCart|ShoppingCart|
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|setmealDto|setmealDto|body|true|套餐封装模型Dto|套餐封装模型Dto|
|&emsp;&emsp;categoryId|分类id||false|integer(int64)||
|&emsp;&emsp;categoryName|||false|string||
|&emsp;&emsp;code|套餐编号||false|string||
|&emsp;&emsp;createTime|||false|string(date-time)||
|&emsp;&emsp;createUser|||false|integer(int64)||
